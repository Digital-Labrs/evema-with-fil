        ...
        <WrapContent>
          ...
          <Stack spacing='5' as='form' py='5' onSubmit={handleSubmit}>
            ...
            <FormControl isRequired>
              ...
              <Input name='location' placeholder='Port Harcourt' />
            </FormControl>
            <Flex>
              <FormControl isRequired>
                <FormLabel>Start Date</FormLabel>
                <Input name='startdate' type='date' placeholder='12 Dec 2022' />
              </FormControl>
              <FormControl isRequired marginLeft={'2'}>
                <FormLabel>End Date</FormLabel>
                <Input name='enddate' type='date' placeholder='12 Jan 2023' />
              </FormControl>
            </Flex>
            <FormControl isRequired>
